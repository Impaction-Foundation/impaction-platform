...
const FluidBackground = () => {
    ...
    useEffect(() => {
        ...
        // The entire fluid simulation script is placed here to run on the client side.
        const initFluid = () => {
            if (!canvas) return;
            ...
            document.body.addEventListener('mousemove', onFirstMouseMove, { once: true });
            window.addEventListener('mousemove', onMouseMove);
            document.body.addEventListener('touchstart', onFirstTouchStart, { once: true });
            ...
            function HSVtoRGB (h: number, s: number, v: number) {
                ...
                let i = Math.floor(h * 2);
                if (theme === 'dark') {
                  switch (i % 2) {
                      case 0: r = 45; g = 212; b = 191; break; // Teal
                      case 1: r = 59; g = 130; b = 246; break; // Blue
                  }
                } else { // light mode
                  switch (i % 2) {
                      case 0: r = 255; g = 193; b = 7; break;  // Yellow
                      case 1: r = 255; g = 87; b = 34; break;  // Orange
                  }
                }
                return { r, g, b };
            }
